...
def parse_arguments(argv):
    ...
    nms_group.add_argument("--nms_mode", type=str, default="per_class", help="one of [global, per_class, torch_batched]")
...
if __name__ == "__main__":
    ...
    print(">>>> COCO evaluation:", data_name, "- anchors:", ANCHORS, "- nms:", NMS)
    run_coco_evaluation(model, data_name, input_shape, args.batch_size, args.resize_method, antialias, args.rescale_mode, **ANCHORS, **NMS)
